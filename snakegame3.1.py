...
def gameLoop():
    ...
    ran_red = random.randint(64, 255)
    ran_green = random.randint(64, 255)
    ran_blue = random.randint(64, 255)
    random_background_color = (ran_red, ran_green, ran_blue)

    #while the game is not over, it will run this:
    while game_over != True:

        #if the player died, it will bring them to this screen
        #this screen is to ask the player to either quit, restart, or go to the speed menu
